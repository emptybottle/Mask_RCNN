...
class RobomasterDataset(utils.Dataset):
    ...
    def load_robomaster(self, dataset_dir, subset):
        ...
        assert dataset_dir in ["image_center", "image_zs", "image_ys", "image_zx", "image_yx","image"]
        # Load annotations
...
dataset_test.load_robomaster("image", "test")
...
for image_id in image_ids:
    ...
    APs.append(AP)
    precisions_s.append(precisions_s)
    recalls_s.append(recalls)
